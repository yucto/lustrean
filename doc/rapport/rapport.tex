...
that widening and narrowing stabilizes in finite time: this requires
classical logic, but then we would not be able to extract the
number of iterations to use it in the interpreter, as it uses
an axiom, and it would be painful since our widening depends on
